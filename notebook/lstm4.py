...
model.add(LSTM(units=50, return_sequences=False,dropout=0.1))
...
train_history = model.fit(x=features_set, y=labels,batch_size=10,epochs=1,shuffle=True,validation_split=0.1)


joblib.dump(model, 'model_4.pkl', compress=9)
joblib.dump(labelEncoder,'lencoder.pkl',compress=9)
joblib.dump(oneHotEncoder,'ohencoder.pkl',compress=9)


temp = joblib.load('C:/Users/gagoyal/Downloads/model/models/model_4.pkl')
