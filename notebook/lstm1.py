# -*- coding: utf-8 -*-
"""
Created on Tue Feb 18 17:30:05 2020
...
#model = Sequential()
#model.add(LSTM(units=52,return_sequences=True,input_shape=(features_set.shape[1], 52),dropout=0.1,recurrent_dropout=0.1))
...
model.add(LSTM(100, input_shape=(features_set.shape[1], 6),return_sequences=True,dropout=0.1))
model.add(LSTM(units=150, return_sequences=False,dropout=0.1))
...
joblib.dump(model, 'model_3.pkl', compress=9)
joblib.dump(labelEncoder,'lencoder.pkl',compress=9)
joblib.dump(oneHotEncoder,'ohencoder.pkl',compress=9)


temp = joblib.load('C:/Users/gagoyal/Downloads/model/models/model_3.pkl')
